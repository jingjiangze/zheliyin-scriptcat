// 版本 bump 0.3.11.79 -> 0.3.11.80（P2 多版套版：仅当前版 填充/切版跟切）
// 约定同 ck-bump.cjs：userscript + page-bridge + runtime/stage9/*.js runner。
// 不 bump runtime/reports/*（历史真机验收证据须保持原版本）；不 bump 本轮新增的 multiversion-p2.test.js（无版本字面量）。
"use strict";
const fs = require("fs");
const path = require("path");
const ROOT = "D:/zheliyin-scriptcat";
const OLD = "0.3.11.79", NEW = "0.3.11.80";
