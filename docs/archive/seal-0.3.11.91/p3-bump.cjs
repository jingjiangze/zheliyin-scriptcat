// 版本 bump 0.3.11.80 -> 0.3.11.81（P3 真机验收：P2 多版套版 仅当前版）
// 约定同 p2-bump.cjs：userscript + page-bridge + runtime/stage9/*.js（含新 runner commit-46s）。
"use strict";
const fs = require("fs");
const path = require("path");
const ROOT = "D:/zheliyin-scriptcat";
const OLD = "0.3.11.80", NEW = "0.3.11.81";
