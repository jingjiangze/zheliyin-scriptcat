...
function selfTest() {
  ...
  t("smart-fill-html", cc.indexOf('id="zy-smart-fill"') >= 0 && cc.indexOf('#zy-smart-fill").addEventListener("click", smartFillFromPanel)') >= 0);
  t("both-dispatch", cc.indexOf('type: "templateApply", plans: plans, side: "both"') >= 0 && cc.indexOf('bridgeCall("getTextInventoryAll", 2500)') >= 0);
  t("presets", cc.indexOf("AI_PROVIDERS") >= 0 && cc.indexOf("api.siliconflow.cn") >= 0 && cc.indexOf("api.deepseek.com") >= 0);
  t("bver-const", BVER === "0.3.11.65");
